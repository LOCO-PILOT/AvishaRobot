...
def weebify(update, context):
    ...
    if not string:
        message.reply_text("⬤ ᴜsᴀɢᴇ ➥ `/weebify <text>`", parse_mode=ParseMode.MARKDOWN)
        return
...
def blue(update, context):
    ...
    if not string:
        message.reply_text("⬤ ᴜsᴀɢᴇ ➥ `/blue <text>`", parse_mode=ParseMode.MARKDOWN)
        return
...
def lined(update, context):
    ...
    if not string:
        message.reply_text("⬤ ᴜsᴀɢᴇ ➥ `/lined <text>`", parse_mode=ParseMode.MARKDOWN)
        return
