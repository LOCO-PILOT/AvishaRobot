...
❍ /glogo (Text) *➛* ᴄʀᴇᴀᴛᴇ ᴀ ʟᴏɢᴏ ᴏғ ʏᴏᴜʀ ɢɪᴠᴇɴ ᴛᴇxᴛ ᴏɴ ᴄᴜᴛᴇ ɢɪʀʟs ᴅᴘᴢ. 

❍ /xlogo (text) ➛ ᴄʀᴇᴀᴛᴇ ʏᴏᴜʀ ʟᴏɢᴏ ᴡɪᴛʜ ʏᴏᴜʀ ɴᴀᴍᴇ ᴡɪᴛʜ ᴍᴜʟᴛɪᴘʟᴇ ʙᴀᴄᴋɢʀᴏᴜɴɢ.

❍ /blackpink (Text) *➛* ᴄʀᴇᴀᴛᴇ ᴀ ʟᴏɢᴏ ᴏғ ʙʟᴀᴄᴋᴘɪɴᴋ ғᴏʀᴍᴀᴛᴇ.
"""
