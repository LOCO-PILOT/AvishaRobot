...
import AvishaRobot.modules.sql.global_bans_sql as gban_sql
import AvishaRobot.modules.sql.users_sql as user_sql
from AvishaRobot import DEV_USERS, OWNER_ID, dispatcher
