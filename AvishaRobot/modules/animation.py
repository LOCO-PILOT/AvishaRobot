...
# sleep how many times after each edit in 'indiaanimation'
EDIT_SLEEP = 1
...
@user_admin
@run_async
def indiaanimation(update: Update, context: CallbackContext):
    bot, args = context.bot, context.args
    msg = update.effective_message.reply_text("ʟᴇᴛ's ɢᴏ...")
    for x in range(EDIT_TIMES):
        msg.edit_text(india_ani[x % 50])
        time.sleep(EDIT_SLEEP)
    msg.edit_text("🇮🇳 ᴏᴜʀ ɪɴᴅɪᴀ ɪs ɢʀᴇᴀᴛ...")
...
def policeanimation(update: Update, context: CallbackContext):
    ...
    for x in range(EDIT_TIMES):
        ...
        time.sleep(EDIT_SLEEP)
    msg.edit_text("🧑‍✈️ ᴍᴀsᴛᴇʀᴍɪɴᴅ ᴘᴏʟɪᴄᴇ ɪs ʜᴇʀᴇ")
